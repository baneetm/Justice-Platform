...
const createTables = async () => {
  ...
  try {
    ...
    // Create indexes
    await client.query('CREATE INDEX IF NOT EXISTS idx_cases_citizen ON cases(citizen_id)');
    await client.query('CREATE INDEX IF NOT EXISTS idx_cases_lawyer ON cases(lawyer_id)');
